            ...
            html.Div(className="container pt-4 pt-lg-5 text-white",children=[
                html.Div(className="row gx-0 mb-4 mb-lg-5 align-items-start pt-5 text-white justify-content-between",children=[
                    ...
                    html.Div(className="col-5 text-white drop-sadow",children=[
                        ...
                        html.P(className="text-justify", children=["El cambio climatico constituye una amenaza cada vez mayor para la vida y el desarrollo. Según el ",html.A(className="enlace",children="Grupo Intergubernamental de Expertos sobre el Cambio Climático",href="https://www.ipcc.ch/",target="_blank")," las emisiones mundiales de gases de efecto invernadero siguen aumentando y, si seguimos así, el aumento de la temperatura a nivel mundial superará con creces el límite de 2 grados centígrados establecido como objetivo por los países con el fin de evitar los efectos más peligrosos del cambio climático."]),
                        html.P(className="text-justify",children="ECO Temp busca ser una herramienta que permita mejorar el entendimiento de nuestro país, dando una visión clara de las causas del cambio de temperatura nacional y como, dado nuestras acciones en el presente, podemos afectar al futuro del territorio."),
                        html.P(className="text-justify",children="El cambio climático nos afecta a todos por igual, razón por la que es deber de todos tomar conciencia y trabajar juntos por un futuro mejor.")
